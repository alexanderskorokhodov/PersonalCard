  ...
  const activeKey =
    location.pathname.startsWith('/experience') || location.pathname.startsWith('/cases')
      ...
      : location.pathname === '/about' ||
          location.pathname === '/personal-data-processing' ||
        ...
        <Reveal>
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <div className="text-[15px] leading-6 text-[var(--text-default)] sm:text-[16px]">
                <span className="whitespace-pre-line">
                  {profile.role}
                  <SparkBadgeIcon className="ml-1 inline-block h-[18px] w-[18px] align-[-0.18em]" />
                </span>
              </div>
            </div>
